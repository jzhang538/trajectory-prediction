...
class ngsimDataset(Dataset):
    ...
    def __getitem__(self, false_idx):
        ...
        return hist,fut,grid,nbrs_num,nbrs_fut
    ...
    def collate_fn(self, samples):
        ...
        nbrs_batch_size = 0
        for _,_,_,nbrs_num,_ in samples:
        ...
        goal_batch = torch.zeros(len(samples),2)
        ...
        for sampleId,(hist,fut,grid,nbrs_num,nbrs_fut) in enumerate(samples):
            ...
            goal_batch[sampleId,:]= torch.from_numpy(fut[-1,:])
        ...
        return hist_batch, start_end_batch, nbrs_fut_batch, masks_batch, goal_batch, fut_batch, op_mask_batch
